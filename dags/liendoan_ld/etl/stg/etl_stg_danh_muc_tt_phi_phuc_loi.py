...
# from doan.declare import danh_muc_phi_phuc_loi_test.json


# cac bang dim,sum,fact thì target tương tự
mypath = '/home/airflow/airflow/dags/liendoan_ld/declare/stg/stg_danh_muc_tt_phi_phuc_loi.json'
