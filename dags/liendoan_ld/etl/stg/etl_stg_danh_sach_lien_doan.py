...
mypath = '/home/airflow/airflow/dags/liendoan_ld/declare/stg/stg_danh_sach_lien_doan.json'
...
with DAG(
    ...
    def extract(**kwargs):
        ...
        # string col make ignore
        df["DIA_CHI"] = df["DIA_CHI"].str.replace('\'', '')
        df["TEN_LIEN_DOAN"] = df["TEN_LIEN_DOAN"].str.replace('\'', '')
