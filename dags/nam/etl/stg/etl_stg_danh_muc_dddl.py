...
mypath = '/home/airflow/airflow/dags/nam/declare/stg/stg_danh_muc_dddl_dl.json'
myDag = MYDAG(mypath)
...
with DAG(
    ...
    def extract(**kwargs):
        ti = kwargs['ti']
        # query = """SELECT a."ma_diem_au", a."ten_diem_au", a."dia_chi", b."ma_huyen_tp"
        #             FROM "DU_LICH"."DIA_DIEM_AN_UONG" a
        #             JOIN "DU_LICH"."THONG_TIN_HUYEN_TP" b ON a."ten_huyen_tp" = b."ten_huyen_tp"
        #         """
        ...
        df = df1.join(df2.set_index(["ten_huyen_tp"]), on=["ten_huyen_tp"])
        df = df.drop(['ten_huyen_tp'], axis=1)
        print(df.head(5))
