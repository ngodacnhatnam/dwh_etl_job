...
mypath = '/home/airflow/airflow/dags/nam/declare/stg/stg_thong_tin_ph_tieu_cuc_dl.json'
myDag = MYDAG(mypath)
...
with DAG(
    ...
    def extract(**kwargs):
        ...
        df4 = pd.merge(right=df2, left=df1, how='left')
        df = pd.merge(right=df3, left=df4, left_on='loai_phan_hoi', right_on='ten_loai_ph', how='left')
        print(df.head(5))
        ti.xcom_push('extract_data', df1.to_json(orient='records'))
