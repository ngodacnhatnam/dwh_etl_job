...
from nam_test.general_function.convert import convert_string_to_number

mypath = '/home/airflow/airflow/dags/nam_test/declare/stg/co_so_luu_tru.json'
myDag = MYDAG(mypath)
...
with DAG(
    ...
    def extract(**kwargs):
        ...
        df = connection_src.postgre_conn(ti, query=query)
